...
* [umami](https://github.com/umami-software/umami) ⭐ 38,425 | 🐛 114 | 🌐 TypeScript | 📅 2026-08-27 - 简单、快速、注重隐私的 Google Analytics 替代方案
* [Taxonomy](https://github.com/shadcn-ui/taxonomy) ⭐ 19,289 | 🐛 218 | 🌐 TypeScript | 📅 2026-04-20 - 基于 Next.js 13 和 React 18 构建的开源 Web 应用实验项目
* [Opensaas](https://github.com/wasp-lang/open-saas/) ⭐ 15,660 | 🐛 104 | 🌐 MDX | 📅 2026-08-06 - (免费) 基于 React + Node.js，集成了登录、支付（stripe）、邮件、AI 功能
...
* [apprise](https://github.com/caronc/apprise) ⭐ 17,206 | 🐛 31 | 🌐 Python | 📅 2026-08-29 - 适用于几乎所有平台的推送通知
* [Pagefind](https://github.com/CloudCannon/pagefind) ⭐ 5,428 | 🐛 114 | 🌐 Rust | 📅 2026-08-26 - 博客/文档的静态搜索
* [toprank](https://github.com/nowork-studio/toprank) ⭐ 3,427 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-26 - 开源（MIT）Claude Code 插件，提供 9 个 SEO 和 Google Ads 技能。连接 Google Search Console、PageSpeed Insights、Google Ads API，自动重写 meta 标签、生成 JSON-LD 结构化数据，并将修改直接推送到 WordPress/Strapi/Contentful/Ghost。107 stars。
...
* [supabase](https://github.com/supabase/supabase) ⭐ 108,544 | 🐛 1,059 | 🌐 TypeScript | 📅 2026-08-28 - 基于开源的后端开发解决方案平台
* [appwrite](https://github.com/appwrite/appwrite) ⭐ 57,154 | 🐛 1,027 | 🌐 TypeScript | 📅 2026-08-29 - 用于开发 Web 和移动应用程序的后端平台
...
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,634 | 🐛 617 | 🌐 TypeScript | 📅 2026-08-27
...
* [penpot](https://github.com/penpot/penpot) ⭐ 59,331 | 🐛 794 | 🌐 Clojure | 📅 2026-08-28 - 可平替 Figma 的开源免费工具
...
* [NextAuth](https://github.com/nextauthjs/next-auth) ⭐ 28,350 | 🐛 598 | 🌐 TypeScript | 📅 2026-07-22 - 用户系统, 网络身份验证
...
* [netdata](https://github.com/netdata/netdata) ⭐ 80,342 | 🐛 387 | 🌐 Go | 📅 2026-08-29 - 实时监控服务器、容器和应用程序
...
* [inngest](https://github.com/inngest/inngest) ⭐ 5,774 | 🐛 229 | 🌐 Go | 📅 2026-08-29 - Inngest 是一个开发者平台，将事件流、队列和持久执行结合在一起，形成一个单一的可靠性层。
...
* [acme.sh](https://github.com/acmesh-official/acme.sh) ⭐ 47,552 | 🐛 105 | 🌐 Shell | 📅 2026-08-22 - 免费 SSL 证书一键生成
...
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 66,119 | 🐛 397 | 🌐 TypeScript | 📅 2026-08-28 - 易于维护的开源文档网站
...
* [Upscayl Upscayl](https://github.com/upscayl/upscayl) ⭐ 48,810 | 🐛 53 | 🌐 TypeScript | 📅 2026-08-20 - 免费开源 AI 图像放大器
* [MediaGo](https://github.com/caorushizi/mediago) ⭐ 9,192 | 🐛 70 | 🌐 TypeScript | 📅 2026-08-29 - m3u8 视频在线提取工具
...
* [QuickRecorder](https://github.com/lihaoyun6/QuickRecorder) ⭐ 8,617 | 🐛 176 | 🌐 Swift | 📅 2025-06-11 - 多功能、轻量化、高性能的开源 macOS 屏幕录制工具
...
* [中国独立开发者项目列表](https://github.com/1c7/chinese-independent-developer) ⭐ 61,091 | 🐛 2 | 🌐 Python | 📅 2026-08-28 - 中国独立开发者项目列表
* [中国独立开发者项目列表-程序员版](https://github.com/1c7/chinese-independent-developer/blob/master/README-Programmer-Edition.md) ⭐ 61,091 | 🐛 2 | 🌐 Python | 📅 2026-08-28 - 中国独立开发者项目列表
...
* [Bernstein](https://github.com/sipyourdrink-ltd/bernstein) ⭐ 1,026 | 🐛 141 | 🌐 Python | 📅 2026-08-29 - (Apache 2.0 开源/自部署) 多 Agent 编排器，协调 Claude Code、Codex CLI、Gemini CLI、OpenHands、Cursor、Aider 等 37 个 CLI 编程 Agent 在并行 git worktree 中工作。确定性 Python 调度器（编排零 LLM token），文件状态、MCP server、质量门、成本追踪。
