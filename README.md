...
* [umami](https://github.com/umami-software/umami) ⭐ 38,985 | 🐛 115 | 🌐 TypeScript | 📅 2026-09-23 - 简单、快速、注重隐私的 Google Analytics 替代方案
* [Taxonomy](https://github.com/shadcn-ui/taxonomy) ⭐ 19,292 | 🐛 218 | 🌐 TypeScript | 📅 2026-04-20 - 基于 Next.js 13 和 React 18 构建的开源 Web 应用实验项目
* [Opensaas](https://github.com/wasp-lang/open-saas/) ⭐ 15,995 | 🐛 107 | 🌐 MDX | 📅 2026-09-22 - (免费) 基于 React + Node.js，集成了登录、支付（stripe）、邮件、AI 功能
...
* [extension.js](https://github.com/extension-js/extension.js) ⭐ 5,173 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-24 - 一个无需配置、跨浏览器的扩展开发工具，支持 TypeScript、WebAssembly、React 和现代 JavaScript，专为实用性和快速原型设计而设计
...
* [crxjs](https://github.com/crxjs/chrome-extension-tools) ⭐ 4,171 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-24 - 是一个旨在简化 Chrome 扩展程序捆绑过程的工具库
...
* [apprise](https://github.com/caronc/apprise) ⭐ 17,382 | 🐛 30 | 🌐 Python | 📅 2026-09-24 - 适用于几乎所有平台的推送通知
* [Pagefind](https://github.com/CloudCannon/pagefind) ⭐ 5,481 | 🐛 120 | 🌐 Rust | 📅 2026-09-23 - 博客/文档的静态搜索
* [toprank](https://github.com/nowork-studio/toprank) ⭐ 3,855 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-24 - 开源（MIT）Claude Code 插件，提供 9 个 SEO 和 Google Ads 技能。连接 Google Search Console、PageSpeed Insights、Google Ads API，自动重写 meta 标签、生成 JSON-LD 结构化数据，并将修改直接推送到 WordPress/Strapi/Contentful/Ghost。107 stars。
...
* [supabase](https://github.com/supabase/supabase) ⭐ 110,723 | 🐛 1,086 | 🌐 TypeScript | 📅 2026-09-24 - 基于开源的后端开发解决方案平台
* [appwrite](https://github.com/appwrite/appwrite) ⭐ 57,453 | 🐛 677 | 🌐 PHP | 📅 2026-09-24 - 用于开发 Web 和移动应用程序的后端平台
...
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,658 | 🐛 669 | 🌐 TypeScript | 📅 2026-09-21
* [Prisma](https://prisma.io/)
* [Sequelize](https://sequelize.org/) - 最老牌的 Node.js ORM 库，支持多种数据库

### 样式与 UI 框架

* [canvas-confetti](https://github.com/catdad/canvas-confetti) ⭐ 12,765 | 🐛 41 | 🌐 JavaScript | 📅 2025-10-25 - 只要一行代码就能添加特效，支持撒花、放烟花、下雪多种特效，也可以自定义撒花的元素。
* [一个专门处理数字动画的 React 组件](https://github.com/barvian/number-flow) ⭐ 7,713 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-20
...
* [penpot](https://github.com/penpot/penpot) ⭐ 60,326 | 🐛 783 | 🌐 Clojure | 📅 2026-09-24 - 可平替 Figma 的开源免费工具
* [OpenUI](https://github.com/wandb/openui) ⭐ 22,568 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-19 - 与 v0.dev 相似，但是是基于 Prompt 构建 UI 组件
...
* [netdata](https://github.com/netdata/netdata) ⭐ 80,641 | 🐛 410 | 🌐 Go | 📅 2026-09-24 - 实时监控服务器、容器和应用程序
...
* [Sink](https://github.com/ccbikai/Sink) ⭐ 7,156 | 🐛 21 | 🌐 Vue | 📅 2026-09-21 - 一个简单/快速/安全的链接缩短器，带有分析功能，100% 运行在 Cloudflare 上。
* [inngest](https://github.com/inngest/inngest) ⭐ 5,880 | 🐛 236 | 🌐 Go | 📅 2026-09-24 - Inngest 是一个开发者平台，将事件流、队列和持久执行结合在一起，形成一个单一的可靠性层。
...
* [acme.sh](https://github.com/acmesh-official/acme.sh) ⭐ 47,705 | 🐛 102 | 🌐 Shell | 📅 2026-09-20 - 免费 SSL 证书一键生成
...
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 66,329 | 🐛 394 | 🌐 TypeScript | 📅 2026-09-24 - 易于维护的开源文档网站
...
* [Upscayl Upscayl](https://github.com/upscayl/upscayl) ⭐ 49,865 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-15 - 免费开源 AI 图像放大器
...
* [screenity](https://github.com/alyssaxuu/screenity) ⭐ 18,726 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-22 - 一款开源的屏幕录制和标注工具，提供隐私保护且无任何使用限制
* [QuickRecorder](https://github.com/lihaoyun6/QuickRecorder) ⭐ 8,669 | 🐛 182 | 🌐 Swift | 📅 2025-06-11 - 多功能、轻量化、高性能的开源 macOS 屏幕录制工具
...
* [中国独立开发者项目列表](https://github.com/1c7/chinese-independent-developer) ⭐ 61,552 | 🐛 4 | 📅 2026-09-24 - 中国独立开发者项目列表
* [中国独立开发者项目列表-程序员版](https://github.com/1c7/chinese-independent-developer/blob/master/README-Programmer-Edition.md) ⭐ 61,552 | 🐛 4 | 📅 2026-09-24 - 中国独立开发者项目列表
...
* [Bernstein](https://github.com/sipyourdrink-ltd/bernstein) ⭐ 1,263 | 🐛 351 | 🌐 Python | 📅 2026-09-24 - (Apache 2.0 开源/自部署) 多 Agent 编排器，协调 Claude Code、Codex CLI、Gemini CLI、OpenHands、Cursor、Aider 等 37 个 CLI 编程 Agent 在并行 git worktree 中工作。确定性 Python 调度器（编排零 LLM token），文件状态、MCP server、质量门、成本追踪。
...
[<img src="https://contrib.nn.ci/api?repo=yaolifeng0629/Awesome-independent-tools" />](https://github.com/yaolifeng0629/Awesome-independent-tools/graphs/contributors) ⭐ 2,456 | 🐛 81 | 📅 2026-09-06
