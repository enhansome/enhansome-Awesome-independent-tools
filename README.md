...
* [umami](https://github.com/umami-software/umami) ⭐ 38,196 | 🐛 96 | 🌐 TypeScript | 📅 2026-08-14 - 简单、快速、注重隐私的 Google Analytics 替代方案
* [Taxonomy](https://github.com/shadcn-ui/taxonomy) ⭐ 19,285 | 🐛 219 | 🌐 TypeScript | 📅 2026-04-20 - 基于 Next.js 13 和 React 18 构建的开源 Web 应用实验项目
* [Opensaas](https://github.com/wasp-lang/open-saas/) ⭐ 15,307 | 🐛 102 | 🌐 MDX | 📅 2026-08-06 - (免费) 基于 React + Node.js，集成了登录、支付（stripe）、邮件、AI 功能
* [NotionNext](https://github.com/tangly1024/NotionNext) ⭐ 11,751 | 🐛 61 | 🌐 JavaScript | 📅 2026-08-14 - NotionNext，Notion 免费开源建站工具，将笔记转化为高性能静态网站
...
* [extension.js](https://github.com/extension-js/extension.js) ⭐ 5,063 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-09 - 一个无需配置、跨浏览器的扩展开发工具，支持 TypeScript、WebAssembly、React 和现代 JavaScript，专为实用性和快速原型设计而设计
...
* [apprise](https://github.com/caronc/apprise) ⭐ 17,049 | 🐛 27 | 🌐 Python | 📅 2026-08-12 - 适用于几乎所有平台的推送通知
* [Pagefind](https://github.com/CloudCannon/pagefind) ⭐ 5,407 | 🐛 119 | 🌐 Rust | 📅 2026-08-15 - 博客/文档的静态搜索
* [toprank](https://github.com/nowork-studio/toprank) ⭐ 3,359 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-14 - 开源（MIT）Claude Code 插件，提供 9 个 SEO 和 Google Ads 技能。连接 Google Search Console、PageSpeed Insights、Google Ads API，自动重写 meta 标签、生成 JSON-LD 结构化数据，并将修改直接推送到 WordPress/Strapi/Contentful/Ghost。107 stars。
* [Mind Elixir](https://github.com/SSShooter/mind-elixir-core) ⭐ 3,128 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-13 - 前端轻松接入思维导图，无框架限制
...
* [supabase](https://github.com/supabase/supabase) ⭐ 108,002 | 🐛 1,274 | 🌐 TypeScript | 📅 2026-08-14 - 基于开源的后端开发解决方案平台
* [appwrite](https://github.com/appwrite/appwrite) ⭐ 56,988 | 🐛 998 | 🌐 TypeScript | 📅 2026-08-15 - 用于开发 Web 和移动应用程序的后端平台
...
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,630 | 🐛 615 | 🌐 TypeScript | 📅 2026-08-13
* [Sequelize](https://sequelize.org/) - 最老牌的 Node.js ORM 库，支持多种数据库

### 样式与 UI 框架

* [canvas-confetti](https://github.com/catdad/canvas-confetti) ⭐ 12,702 | 🐛 41 | 🌐 JavaScript | 📅 2025-10-25 - 只要一行代码就能添加特效，支持撒花、放烟花、下雪多种特效，也可以自定义撒花的元素。
* [一个专门处理数字动画的 React 组件](https://github.com/barvian/number-flow) ⭐ 7,634 | 🐛 19 | 🌐 TypeScript | 📅 2026-07-18
...
* [penpot](https://github.com/penpot/penpot) ⭐ 58,584 | 🐛 804 | 🌐 Clojure | 📅 2026-08-14 - 可平替 Figma 的开源免费工具
* [OpenUI](https://github.com/wandb/openui) ⭐ 22,509 | 🐛 89 | 🌐 TypeScript | 📅 2026-08-14 - 与 v0.dev 相似，但是是基于 Prompt 构建 UI 组件
...
* [NextAuth](https://github.com/nextauthjs/next-auth) ⭐ 28,325 | 🐛 594 | 🌐 TypeScript | 📅 2026-07-22 - 用户系统, 网络身份验证
...
* [netdata](https://github.com/netdata/netdata) ⭐ 80,187 | 🐛 391 | 🌐 Go | 📅 2026-08-15 - 实时监控服务器、容器和应用程序
...
* [Sink](https://github.com/ccbikai/Sink) ⭐ 7,017 | 🐛 13 | 🌐 Vue | 📅 2026-08-09 - 一个简单/快速/安全的链接缩短器，带有分析功能，100% 运行在 Cloudflare 上。
* [inngest](https://github.com/inngest/inngest) ⭐ 5,726 | 🐛 234 | 🌐 Go | 📅 2026-08-14 - Inngest 是一个开发者平台，将事件流、队列和持久执行结合在一起，形成一个单一的可靠性层。
...
* [acme.sh](https://github.com/acmesh-official/acme.sh) ⭐ 47,475 | 🐛 91 | 🌐 Shell | 📅 2026-08-14 - 免费 SSL 证书一键生成
...
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 65,925 | 🐛 427 | 🌐 TypeScript | 📅 2026-08-13 - 易于维护的开源文档网站
...
* [Upscayl Upscayl](https://github.com/upscayl/upscayl) ⭐ 48,274 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-04 - 免费开源 AI 图像放大器
* [MediaGo](https://github.com/caorushizi/mediago) ⭐ 9,124 | 🐛 83 | 🌐 TypeScript | 📅 2026-08-15 - m3u8 视频在线提取工具
...
* [screenity](https://github.com/alyssaxuu/screenity) ⭐ 18,484 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-07 - 一款开源的屏幕录制和标注工具，提供隐私保护且无任何使用限制
...
* [中国独立开发者项目列表](https://github.com/1c7/chinese-independent-developer) ⭐ 60,805 | 🐛 2 | 🌐 Python | 📅 2026-08-15 - 中国独立开发者项目列表
* [中国独立开发者项目列表-程序员版](https://github.com/1c7/chinese-independent-developer/blob/master/README-Programmer-Edition.md) ⭐ 60,805 | 🐛 2 | 🌐 Python | 📅 2026-08-15 - 中国独立开发者项目列表
...
* [AgentsMesh](https://github.com/AgentsMesh/AgentsMesh) ⭐ 2,307 | 🐛 20 | 🌐 Go | 📅 2026-08-03 - (免费开源/自部署) AI Agent 编排平台，并行运行 Claude Code、Codex CLI、Gemini CLI、Aider、OpenCode，内置 Kanban 任务管理 + Git worktree 隔离 + MCP Server。支持 GitHub/GitLab/**Gitee**，BYOK 模式用户自带 API key 无平台费。
* [Bernstein](https://github.com/sipyourdrink-ltd/bernstein) ⭐ 884 | 🐛 167 | 🌐 Python | 📅 2026-08-15 - (Apache 2.0 开源/自部署) 多 Agent 编排器，协调 Claude Code、Codex CLI、Gemini CLI、OpenHands、Cursor、Aider 等 37 个 CLI 编程 Agent 在并行 git worktree 中工作。确定性 Python 调度器（编排零 LLM token），文件状态、MCP server、质量门、成本追踪。
