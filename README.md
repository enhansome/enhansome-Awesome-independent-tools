...
* [umami](https://github.com/umami-software/umami) ⭐ 38,739 | 🐛 123 | 🌐 TypeScript | 📅 2026-09-11 - 简单、快速、注重隐私的 Google Analytics 替代方案
* [Taxonomy](https://github.com/shadcn-ui/taxonomy) ⭐ 19,291 | 🐛 218 | 🌐 TypeScript | 📅 2026-04-20 - 基于 Next.js 13 和 React 18 构建的开源 Web 应用实验项目
* [Opensaas](https://github.com/wasp-lang/open-saas/) ⭐ 15,778 | 🐛 103 | 🌐 MDX | 📅 2026-08-06 - (免费) 基于 React + Node.js，集成了登录、支付（stripe）、邮件、AI 功能
* [NotionNext](https://github.com/tangly1024/NotionNext) ⭐ 11,815 | 🐛 24 | 🌐 JavaScript | 📅 2026-09-08 - NotionNext，Notion 免费开源建站工具，将笔记转化为高性能静态网站
...
* [extension.js](https://github.com/extension-js/extension.js) ⭐ 5,153 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-11 - 一个无需配置、跨浏览器的扩展开发工具，支持 TypeScript、WebAssembly、React 和现代 JavaScript，专为实用性和快速原型设计而设计
...
* [apprise](https://github.com/caronc/apprise) ⭐ 17,297 | 🐛 29 | 🌐 Python | 📅 2026-09-10 - 适用于几乎所有平台的推送通知
* [Pagefind](https://github.com/CloudCannon/pagefind) ⭐ 5,458 | 🐛 119 | 🌐 Rust | 📅 2026-09-10 - 博客/文档的静态搜索
* [toprank](https://github.com/nowork-studio/toprank) ⭐ 3,726 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-11 - 开源（MIT）Claude Code 插件，提供 9 个 SEO 和 Google Ads 技能。连接 Google Search Console、PageSpeed Insights、Google Ads API，自动重写 meta 标签、生成 JSON-LD 结构化数据，并将修改直接推送到 WordPress/Strapi/Contentful/Ghost。107 stars。
...
* [supabase](https://github.com/supabase/supabase) ⭐ 109,052 | 🐛 1,125 | 🌐 TypeScript | 📅 2026-09-11 - 基于开源的后端开发解决方案平台
* [appwrite](https://github.com/appwrite/appwrite) ⭐ 57,349 | 🐛 1,008 | 🌐 TypeScript | 📅 2026-09-11 - 用于开发 Web 和移动应用程序的后端平台
* [notify](https://github.com/nikoksr/notify) ⭐ 3,853 | 🐛 44 | 🌐 Go | 📅 2026-09-07 - Go 语言，用于向各种消息服务发送通知
...
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,654 | 🐛 640 | 🌐 TypeScript | 📅 2026-09-11
...
* [penpot](https://github.com/penpot/penpot) ⭐ 59,887 | 🐛 766 | 🌐 Clojure | 📅 2026-09-11 - 可平替 Figma 的开源免费工具
* [OpenUI](https://github.com/wandb/openui) ⭐ 22,540 | 🐛 87 | 🌐 TypeScript | 📅 2026-09-10 - 与 v0.dev 相似，但是是基于 Prompt 构建 UI 组件
...
* [Nodemailer](https://github.com/nodemailer/nodemailer) ⭐ 17,672 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-11 - Node.js 的邮件发送库
...
* [netdata](https://github.com/netdata/netdata) ⭐ 80,483 | 🐛 393 | 🌐 Go | 📅 2026-09-11 - 实时监控服务器、容器和应用程序
...
* [Sink](https://github.com/ccbikai/Sink) ⭐ 7,110 | 🐛 21 | 🌐 Vue | 📅 2026-08-20 - 一个简单/快速/安全的链接缩短器，带有分析功能，100% 运行在 Cloudflare 上。
* [inngest](https://github.com/inngest/inngest) ⭐ 5,822 | 🐛 234 | 🌐 Go | 📅 2026-09-11 - Inngest 是一个开发者平台，将事件流、队列和持久执行结合在一起，形成一个单一的可靠性层。
...
* [acme.sh](https://github.com/acmesh-official/acme.sh) ⭐ 47,623 | 🐛 99 | 🌐 Shell | 📅 2026-09-11 - 免费 SSL 证书一键生成
...
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 66,226 | 🐛 398 | 🌐 TypeScript | 📅 2026-09-11 - 易于维护的开源文档网站
...
* [Upscayl Upscayl](https://github.com/upscayl/upscayl) ⭐ 49,157 | 🐛 49 | 🌐 TypeScript | 📅 2026-08-20 - 免费开源 AI 图像放大器
* [MediaGo](https://github.com/caorushizi/mediago) ⭐ 9,221 | 🐛 76 | 🌐 TypeScript | 📅 2026-09-11 - m3u8 视频在线提取工具
...
* [QuickRecorder](https://github.com/lihaoyun6/QuickRecorder) ⭐ 8,645 | 🐛 177 | 🌐 Swift | 📅 2025-06-11 - 多功能、轻量化、高性能的开源 macOS 屏幕录制工具
...
* [中国独立开发者项目列表](https://github.com/1c7/chinese-independent-developer) ⭐ 61,397 | 🐛 2 | 📅 2026-09-10 - 中国独立开发者项目列表
* [中国独立开发者项目列表-程序员版](https://github.com/1c7/chinese-independent-developer/blob/master/README-Programmer-Edition.md) ⭐ 61,397 | 🐛 2 | 📅 2026-09-10 - 中国独立开发者项目列表
...
* [Bernstein](https://github.com/sipyourdrink-ltd/bernstein) ⭐ 1,159 | 🐛 331 | 🌐 Python | 📅 2026-09-11 - (Apache 2.0 开源/自部署) 多 Agent 编排器，协调 Claude Code、Codex CLI、Gemini CLI、OpenHands、Cursor、Aider 等 37 个 CLI 编程 Agent 在并行 git worktree 中工作。确定性 Python 调度器（编排零 LLM token），文件状态、MCP server、质量门、成本追踪。
...
[<img src="https://contrib.nn.ci/api?repo=yaolifeng0629/Awesome-independent-tools" />](https://github.com/yaolifeng0629/Awesome-independent-tools/graphs/contributors) ⭐ 2,452 | 🐛 75 | 📅 2026-09-06
