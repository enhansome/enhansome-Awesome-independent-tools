...
* [umami](https://github.com/umami-software/umami) ⭐ 38,174 | 🐛 91 | 🌐 TypeScript | 📅 2026-08-12 - 简单、快速、注重隐私的 Google Analytics 替代方案
* [Taxonomy](https://github.com/shadcn-ui/taxonomy) ⭐ 19,287 | 🐛 219 | 🌐 TypeScript | 📅 2026-04-20 - 基于 Next.js 13 和 React 18 构建的开源 Web 应用实验项目
* [Opensaas](https://github.com/wasp-lang/open-saas/) ⭐ 15,291 | 🐛 115 | 🌐 MDX | 📅 2026-08-06 - (免费) 基于 React + Node.js，集成了登录、支付（stripe）、邮件、AI 功能
* [NotionNext](https://github.com/tangly1024/NotionNext) ⭐ 11,741 | 🐛 60 | 🌐 JavaScript | 📅 2026-08-13 - NotionNext，Notion 免费开源建站工具，将笔记转化为高性能静态网站
* [lucky-canvas 抽奖插件](https://github.com/buuing/lucky-canvas) ⭐ 8,748 | 🐛 193 | 🌐 TypeScript | 📅 2026-07-30 - 基于 TS + Canvas 抽奖插件，🌈 一套源码适配多端框架 JS / Vue / React / Taro / UniApp / 微信小程序等
* [mp-html](https://github.com/jin-yufeng/mp-html) ⭐ 3,732 | 🐛 67 | 🌐 JavaScript | 📅 2026-04-19 - 小程序富文本组件，支持渲染和编辑 html，支持在微信、QQ、百度、支付宝、头条和 uni-app 平台使用
* [unibest](https://github.com/codercup/unibest) ⭐ 2,857 | 🐛 93 | 🌐 TypeScript | 📅 2026-03-28 - unibest 是由 uniapp + Vue3 + Ts + Vite4 + UnoCss + UniUI 驱动的跨端快速启动模板
...
* [extension.js](https://github.com/extension-js/extension.js) ⭐ 5,061 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-09 - 一个无需配置、跨浏览器的扩展开发工具，支持 TypeScript、WebAssembly、React 和现代 JavaScript，专为实用性和快速原型设计而设计
...
* [crxjs](https://github.com/crxjs/chrome-extension-tools) ⭐ 4,150 | 🐛 46 | 🌐 TypeScript | 📅 2026-07-05 - 是一个旨在简化 Chrome 扩展程序捆绑过程的工具库
...
* [chrome-extension-typescript-starter](https://github.com/chibat/chrome-extension-typescript-starter) ⭐ 2,821 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-05
...
* [apprise](https://github.com/caronc/apprise) ⭐ 17,039 | 🐛 27 | 🌐 Python | 📅 2026-08-12 - 适用于几乎所有平台的推送通知
* [Pagefind](https://github.com/CloudCannon/pagefind) ⭐ 5,405 | 🐛 141 | 🌐 Rust | 📅 2026-08-12 - 博客/文档的静态搜索
* [toprank](https://github.com/nowork-studio/toprank) ⭐ 3,350 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-13 - 开源（MIT）Claude Code 插件，提供 9 个 SEO 和 Google Ads 技能。连接 Google Search Console、PageSpeed Insights、Google Ads API，自动重写 meta 标签、生成 JSON-LD 结构化数据，并将修改直接推送到 WordPress/Strapi/Contentful/Ghost。107 stars。
* [Mind Elixir](https://github.com/SSShooter/mind-elixir-core) ⭐ 3,120 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-13 - 前端轻松接入思维导图，无框架限制
...
* [supabase](https://github.com/supabase/supabase) ⭐ 107,917 | 🐛 1,271 | 🌐 TypeScript | 📅 2026-08-13 - 基于开源的后端开发解决方案平台
* [appwrite](https://github.com/appwrite/appwrite) ⭐ 56,907 | 🐛 991 | 🌐 TypeScript | 📅 2026-08-13 - 用于开发 Web 和移动应用程序的后端平台
* [notify](https://github.com/nikoksr/notify) ⭐ 3,753 | 🐛 47 | 🌐 Go | 📅 2026-08-10 - Go 语言，用于向各种消息服务发送通知
...
* [TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,626 | 🐛 614 | 🌐 TypeScript | 📅 2026-08-13
* [Sequelize](https://sequelize.org/) - 最老牌的 Node.js ORM 库，支持多种数据库

### 样式与 UI 框架

* [canvas-confetti](https://github.com/catdad/canvas-confetti) ⭐ 12,697 | 🐛 41 | 🌐 JavaScript | 📅 2025-10-25 - 只要一行代码就能添加特效，支持撒花、放烟花、下雪多种特效，也可以自定义撒花的元素。
* [一个专门处理数字动画的 React 组件](https://github.com/barvian/number-flow) ⭐ 7,629 | 🐛 19 | 🌐 TypeScript | 📅 2026-07-18
...
* [penpot](https://github.com/penpot/penpot) ⭐ 58,489 | 🐛 796 | 🌐 Clojure | 📅 2026-08-13 - 可平替 Figma 的开源免费工具
* [OpenUI](https://github.com/wandb/openui) ⭐ 22,500 | 🐛 89 | 🌐 TypeScript | 📅 2026-08-05 - 与 v0.dev 相似，但是是基于 Prompt 构建 UI 组件
...
* [NextAuth](https://github.com/nextauthjs/next-auth) ⭐ 28,324 | 🐛 592 | 🌐 TypeScript | 📅 2026-07-22 - 用户系统, 网络身份验证
...
* [Nodemailer](https://github.com/nodemailer/nodemailer) ⭐ 17,648 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-12 - Node.js 的邮件发送库
...
* [netdata](https://github.com/netdata/netdata) ⭐ 80,158 | 🐛 382 | 🌐 Go | 📅 2026-08-13 - 实时监控服务器、容器和应用程序
...
* [Sink](https://github.com/ccbikai/Sink) ⭐ 7,011 | 🐛 11 | 🌐 Vue | 📅 2026-08-09 - 一个简单/快速/安全的链接缩短器，带有分析功能，100% 运行在 Cloudflare 上。
* [inngest](https://github.com/inngest/inngest) ⭐ 5,719 | 🐛 238 | 🌐 Go | 📅 2026-08-12 - Inngest 是一个开发者平台，将事件流、队列和持久执行结合在一起，形成一个单一的可靠性层。
...
* [acme.sh](https://github.com/acmesh-official/acme.sh) ⭐ 47,465 | 🐛 90 | 🌐 Shell | 📅 2026-08-13 - 免费 SSL 证书一键生成
* [使用 Cloudflare Pages 部署 UptimeRobot API 在线状态面板：`项目`](https://github.com/shaoyouvip/uptime) ⭐ 55 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-26
...
* [Docusaurus](https://github.com/facebook/docusaurus) ⭐ 65,905 | 🐛 424 | 🌐 TypeScript | 📅 2026-08-07 - 易于维护的开源文档网站
...
* [Upscayl Upscayl](https://github.com/upscayl/upscayl) ⭐ 48,087 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-04 - 免费开源 AI 图像放大器
* [MediaGo](https://github.com/caorushizi/mediago) ⭐ 9,120 | 🐛 78 | 🌐 TypeScript | 📅 2026-08-11 - m3u8 视频在线提取工具
...
* [screenity](https://github.com/alyssaxuu/screenity) ⭐ 18,480 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-07 - 一款开源的屏幕录制和标注工具，提供隐私保护且无任何使用限制
* [QuickRecorder](https://github.com/lihaoyun6/QuickRecorder) ⭐ 8,578 | 🐛 173 | 🌐 Swift | 📅 2025-06-11 - 多功能、轻量化、高性能的开源 macOS 屏幕录制工具
...
* [中国独立开发者项目列表](https://github.com/1c7/chinese-independent-developer) ⭐ 60,769 | 🐛 1 | 🌐 Python | 📅 2026-08-13 - 中国独立开发者项目列表
* [中国独立开发者项目列表-程序员版](https://github.com/1c7/chinese-independent-developer/blob/master/README-Programmer-Edition.md) ⭐ 60,769 | 🐛 1 | 🌐 Python | 📅 2026-08-13 - 中国独立开发者项目列表
...
* [Gingiris 开源项目增长 Playbook](https://github.com/Gingiris/gingiris-opensource) ⭐ 246 | 🐛 2 | 📅 2026-05-07 - 从 0 到 60k+ GitHub Star 的完整操盘手册，覆盖 HN、Reddit、V2EX 等全渠道推广策略
* [Gingiris AI 产品发布 Playbook](https://github.com/Gingiris/gingiris-launch) ⭐ 196 | 🐛 3 | 📅 2026-05-07 - 基于 30+ 次 Product Hunt #1 经验的完整发布 SOP，含 KOL 外联、Reddit 营销、UGC 制作模板，完全免费开源
* [Gingiris B2B SaaS 增长 Playbook](https://github.com/Gingiris/gingiris-b2b-growth) ⭐ 93 | 🐛 2 | 📅 2026-05-07 - 从 PMF 到 $10M ARR 的完整增长框架，含 PLG/SLG/渠道合作策略和可直接使用的模板
* [Gingiris ASO & App 冷启动 Playbook](https://github.com/Gingiris/gingiris-aso-growth) ⭐ 10 | 🐛 1 | 📅 2026-05-07 - App Store 和 Google Play 关键词优化、元数据策略与冷启动用户获取完整指南
...
* [AgentsMesh](https://github.com/AgentsMesh/AgentsMesh) ⭐ 2,306 | 🐛 20 | 🌐 Go | 📅 2026-08-03 - (免费开源/自部署) AI Agent 编排平台，并行运行 Claude Code、Codex CLI、Gemini CLI、Aider、OpenCode，内置 Kanban 任务管理 + Git worktree 隔离 + MCP Server。支持 GitHub/GitLab/**Gitee**，BYOK 模式用户自带 API key 无平台费。
* [Bernstein](https://github.com/sipyourdrink-ltd/bernstein) ⭐ 853 | 🐛 132 | 🌐 Python | 📅 2026-08-13 - (Apache 2.0 开源/自部署) 多 Agent 编排器，协调 Claude Code、Codex CLI、Gemini CLI、OpenHands、Cursor、Aider 等 37 个 CLI 编程 Agent 在并行 git worktree 中工作。确定性 Python 调度器（编排零 LLM token），文件状态、MCP server、质量门、成本追踪。
